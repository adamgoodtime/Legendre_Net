...
ax1.plot(legendre_x, legendre_values_vex, color='g', label='Convex')
ax1.plot(legendre_x, legendre_values_cave, color='b', label='Concave')
ax1.plot(legendre_x, legendre_values_total, 'k', label='Combination')

ax1.plot(x, s_total, 'r--', label='Original function')
